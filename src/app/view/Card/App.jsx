...
export default function TestCasesCardView() {
    ...
    return (
        <div className="min-h-screen w-full bg-gradient-to-br from-indigo-50 via-purple-50 to-pink-50 p-2">
            <motion.div
                        ...
                        {filteredTestCases.map((testCase, index) => {
                            ...
                            return (
                                <motion.div
                                    ...
                                    className={`bg-white rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 overflow-hidden border border-gray-100 ${viewMode === 'list' ? 'flex items-center' : ''
                                        }`}
                                >
                    ...
                    {selectedCase && (
                        ...
                        >
                            <motion.div
                                ...
                                className="bg-white rounded-3xl shadow-2xl max-w-full w-full max-h-full overflow-y-auto"
                            >
                                {/* Modal Header */}
