                ...
                <AnimatePresence>
                    {selectedCase && (
                        <motion.div
                            ...
                            animate={{ opacity: 1 }}
                            exit={{ opacity: 0 }}
                            className="fixed inset-0  bg-opacity-50 flex items-center justify-center sidebar-scrollbar z-50"
                        ...
                        >
                            <motion.div
                                ...
                                className="bg-white shadow-2xl w-full max-h-full overflow-y-auto"
                            >
