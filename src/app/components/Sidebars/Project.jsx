...
const CustomThreeDotsDropdown = ({ options, projectId }) => {
  ...
  const calculatePosition = (buttonElement) => {
    ...
    // Vertical positioning - align dropdown top with button top or bottom with button bottom
    if (spaceBelow >= dropdownHeight || spaceBelow > spaceAbove) {
      // Open downward - align dropdown top with button bottom
      top = buttonRect.bottom + 4;
      direction = "bottom";
    } else {
      // Open upward - align dropdown bottom with button top
      top = buttonRect.top - dropdownHeight - 4;
      direction = "top";
    }

    // Horizontal positioning - align dropdown right edge with button right edge
      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="w-52 bg-white rounded-lg shadow-lg border border-slate-200/60 overflow-hidden"
          >
            <div className="py-2">
