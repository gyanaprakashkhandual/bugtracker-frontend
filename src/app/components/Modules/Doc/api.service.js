  ...
  return (
    <div
      ...
      data-editor-context={{
        ...
        isLoading, error, success, isSaving,
        selectedText, selectionStart, selectionEnd,
        textFormats, currentFormat, setCurrentFormat,
        comments, showCommentBox, setShowCommentBox,
        commentText, setCommentText,
        replyingTo, setReplyingTo,
        replyText, setReplyText,
        suggestions, showSuggestionBox, setShowSuggestionBox,
        suggestionText, setSuggestionText,
        suggestionDescription, setSuggestionDescription,
        versions, showVersionModal, setShowVersionModal,
        versionName, setVersionName,
        versionDescription, setVersionDescription,
        collaborators, currentEditors,
        showCollaboratorBox, setShowCollaboratorBox,
        collaboratorEmail, setCollaboratorEmail,
        collaboratorPermission, setCollaboratorPermission,
        images, attachments, tables, codeBlocks,
        accessLogs, viewCount,
        cursorPosition, autoSaveEnabled, setAutoSaveEnabled,
        wordCount, characterCount, editorRef,

        // API Functions
        createNewDoc, fetchDocById, updateDocInfo,
        searchDocuments, getDocsByCategory, getRecentDocuments,
        exportDocument, updateDocStatus, duplicateDocument,
        getDocStats, togglePin, toggleStar,
        ...
        addCollaborator, updateCollaboratorPermission,
        removeCollaborator, fetchCollaborators,
        ...
        applyTextFormatting, applyAlignment,
        applyTextColor, applyBackgroundColor,
        applyFontSize, removeAllFormatting, clearFormatInRange,

        // Utility Functions
        calculateTextStats, getSelectedRange,
        updateCursorStats, showNotification,
        copyToClipboard, downloadFile,

        // Handler Functions
        handleSaveDocument, handleAddTag, handleRemoveTag,
        handleCommentCreate, handleCommentReply,
        handleSuggestionCreate, handleCollaboratorAdd,
        handleVersionCreate,

        // Upload Functions
        uploadToCloudinary, handleImageUpload,
        handleMultipleImageUpload, handleFileUpload,
        handleMultipleFileUpload, handleVideoUpload,
    ...
    >
      {/* All states and functions are accessible via the data-editor-context attribute */}
      {/* You can now build your UI components here and access context via the functions passed down */}
      <div className="flex-1 p-4">
        ...
        {error && (
          <div className="fixed top-4 right-4 bg-red-500 text-white px-4 py-2 rounded-lg shadow-lg flex items-center gap-2">
