    ...
    const contactInfo = [
        {
            icon: Mail,
            title: 'Email',
            value: 'gyanaprakashkhnadual@gmail.com',
        ...
        },
        {
            ...
            title: 'Phone',
            value: '+91 7894174893',
            href: 'tel:+917874174893',
            color: 'from-green-500 to-emerald-500'
        },
        {
            icon: MapPin,
            title: 'Address',
            value: 'East Bhubaneswar, Odisha, India',
                ...
                <div className="grid lg:grid-cols-3 gap-8">
                    ...
                    >
                        ...
                        <motion.div
                            ...
                            className="bg-gradient-to-br from-indigo-500 to-purple-600 rounded-2xl p-4 shadow-lg text-white"
                        >
                        ...
                        <div className="bg-white rounded-3xl shadow-xl p-8 border border-gray-100">
                            ...
                            <div className="space-y-5">
                                ...
                                <motion.button
                                    ...
                                    className={`w-full py-4 rounded-xl font-semibold text-white shadow-lg transition-all ${submitting
