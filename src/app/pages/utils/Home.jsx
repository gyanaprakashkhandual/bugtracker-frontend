...
export default function CaffetestLanding() {
  ...
  const coreFeatures = [
    ...
    },
    {
      icon: FaFileAlt,
      title: "Test Cases",
      description: "Full test case management with CRUD operations",
      color: "bg-blue-500"
    },
    {
      icon: FaRocket,
      title: "Issue Management",
      description: "Enterprise-grade issue tracking for modern workflows",
      color: "bg-purple-500"
    },
    {
      icon: FaFileAlt,
      title: "Built-in Documentation",
      description: "Google Docs-like editor integrated within the platform",
      color: "bg-green-500"
    },
    {
      icon: FaTable,
      title: "Excel Integration",
      description: "Complete spreadsheet capabilities built right in",
      color: "bg-orange-500"
    },
    {
      icon: FaRobot,
      title: "Lumen AI Assistant",
      description: "ChatGPT-powered AI for test management and queries",
      color: "bg-indigo-500"
    }
  ]
            ...
            <div className="w-full max-w-4xl mx-auto bg-gray-900 rounded-xl shadow-xl border border-gray-200">
              ...
              <div className="p-6 font-mono text-sm text-left overflow-x-auto">
                <div className="space-y-2">
                  ...
                  <div className="mt-4 text-green-400">// ✅ Test passed - Generated by Caffetest AI</div>
                </div>
              </div>
            </div>
          </motion.div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <p className="text-lg text-indigo-100 mb-8 leading-relaxed">
                Your intelligent testing companion powered by ChatGPT. Add, delete, and manage test cases through natural conversation. Ask questions, generate reports, and automate workflows with AI-driven insights.
              </p>
        ...
        <div className="w-full max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            >
              ...
              <p className="text-gray-600 mb-4">CAPTEST extension automatically tracks and sends test data to your dashboard in real-time</p>
              <div className="bg-white rounded-lg p-3 text-sm font-mono text-gray-700">
                ext install caffetest.captest
              </div>
            </motion.div>
