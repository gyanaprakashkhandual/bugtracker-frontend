        ...
        <div className="max-h-[calc(100vh-69px)] p-2 kanban-scrollbar justify-center items-center">
            <div className="flex gap-3 overflow-x-auto">
                {statuses.map((status) => (
                    <motion.div
                        key={status}
                        className={`flex-shrink-0 w-[243px] min-h-[calc(100vh-80px)] ${statusColors[status]} border rounded-lg p-3 transition-all duration-300 ${dragOverColumn === status ? 'ring-2 ring-blue-400 ring-offset-2 scale-[1.02]' : ''
                            }`}
