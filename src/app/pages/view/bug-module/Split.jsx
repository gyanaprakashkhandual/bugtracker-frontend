              ...
              <div className="py-1" role="menu">
                {options.map((option) => (
                  <motion.button
                    ...
                    className={`block w-full text-left px-2.5 py-1.5 text-xs transition-colors font-medium ${
                      value === option
            ...
            <div className="space-y-2 p-3">
              {filteredBugs.map((bug, index) => (
                <motion.div
                  ...
                  className={`bg-white rounded-xl border-2 p-3 cursor-pointer transition-all duration-200 ${
